  ...
  rules: {
    ...
    _lone_expression: $ =>
      choice(
        ...
        $._list_expression,
        $._literal_expression,
        $._string, // TODO: string rule with interpolations
        $._map_expression,
    ...
    _prefixed_identifier: $ => $._qualified,
    ...
    _for_statement: $ =>
      seq(
        'for',
        '(',
        comma_separated($._var_declaration),
        ';',
    ...
    _list_expression: $ =>
      seq('[', comma_separated($._expression), ']'),
    ...
    _map_expression: $ =>
      seq(
        ...
        optional(
          seq(
            choice(
              comma_separated(seq($._expression, ':', $._expression)),
              seq('<', $._type, ':', $._type, '>'),
            ),
            optional(','),
          )
    ...
    _variable_expression: $ => $._qualified,
    ...
    _function_type: $ =>
      prec.left(
        ...
        seq(
          ...
          seq('>', $._type),
          optional(seq('*>', $._type)),
          optional(seq('!>', optional('('), comma_separated($._type), optional(')')))
        )
      ),
    ...
    _object_field: $ =>
      seq(
        optional('static'),
        choice(
          seq($._unqualified_var_declaration, choice(',', ';')),
          $._fun_declaration
        )
      ),
      ...
      prec.left(
        ...
        seq(
          choice(
            ...
            $._function_type,
            $._qualified,
            seq('obj', '{', comma_separated($._var_declaration), '}')
          ),
          optional('?')
        )
      ),
    ...
    _call_expression: $ =>
      prec.left(PREC.CALL, seq($._expression, '(', optional($._argument_list), ')', optional(seq('catch', $._expression)))),
    ...
    _object_init_expression: $ =>
      ...
      _qualified: $ => seq($.identifier, repeat(seq('\\', $.identifier)))
  }
})
